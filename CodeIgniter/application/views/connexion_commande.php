...
?>
<?php echo form_open('commande/connexion_commande'); 
if($message != NULL){
  ?>
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <h2 class="fw-bold mb-2 text-uppercase">Commande</h2>
              <p class="text-white-50 mb-5">Merci de rentrer votre numéro de commande et votre mot de passe !</p>

              <div class="form-outline form-white mb-4">
                <input type="text" id="typeEmailX" class="form-control form-control-lg" name="numcommande" />
                <label class="form-label" for="typeEmailX">Numéro de commande</label>
              </div>
